...
/** The four tiers, as the rest of the app names them. */
export type Tier = Channel['tier'];
import { useVoice } from '../voice/useVoice';
import { t } from '../i18n/index';
import { Screen, Card, Chip, StatusDot, HelpButton } from '../ui/kit';
import { IconForward } from '../ui/icons';
 ...
 */
export const TIER: Record<Tier, { labelKey: string; whyKey: string; tone: string }> = {
