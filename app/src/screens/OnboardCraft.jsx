...
import { interpretChoice } from '../voice/interpret.js';
import { t } from '../i18n/index.js';
import { Screen, Grid, Tile, BigButton, YesNo, MicButton, Heard } from '../ui/kit.jsx';
import {
  IconMic,
  IconRetry,
  IconCraftWeaving,
    ...
    >
      ...
      {(phase === 'rec' || phase === 'busy') && (
        <MicButton
          ...
          onClick={phase === 'rec' ? stopRec : undefined}
        />
      )}
