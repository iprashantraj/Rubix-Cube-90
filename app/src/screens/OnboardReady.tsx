...
import { record, transcribe, classifyYesNo, type RecHandle } from '../voice/listen';
import { t } from '../i18n/index';
import { Screen, BigButton, YesNo, Spinner } from '../ui/kit';
import { IconMic, IconYes, IconRetry } from '../ui/icons';
...
export default function OnboardReady() {
  ...
  async function save(all: Record<string, boolean>) {
    setPhase('busy');
    try {
